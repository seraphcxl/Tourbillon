...
@interface DCHXOREncryptedInputStream () {
}
...
@implementation DCHXOREncryptedInputStream
    ...
    do {
        @synchronized (self) {
            ...
            for (NSUInteger idx = 0; idx < lapCount; ++idx) {
                ...
                DCHAssert(readLen == sha1BlockLen, @"Read password error!");
...
- (NSInteger)read:(uint8_t *)buffer maxLength:(NSUInteger)len {
    ...
    do {
        ...
        @synchronized (self) {
            ...
            DCHAssert(tmpReadCount <= len, @"Read too much data!");
